...
const PatientDocumentManager = ({ patientId, patientName }: PatientDocumentManagerProps) => {
    const { user } = useAuth();
    ...
    // Fetch documents for specific patient
    ...
    const uploadDocumentMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: ['all-documents'] }); // Refresh global list too
    ...
    const handleUpload = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Determine file type from MIME type if not manually selected
                    ...
                    <Card className="col-span-full">
                        <CardContent className="p-6">
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground">Nenašli sa žiadne dokumenty pre tohto pacienta</p>
                                <Button variant="link" className="mt-3" onClick={() => setShowUploadDialog(true)}>
                                    Pridajte prvý dokument
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
            ...
            <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Pridať záznam dokumentu pre pacienta {patientName}
                        </DialogDescription>
                    </DialogHeader>
